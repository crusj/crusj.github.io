...
class Product
{
    ...
    public function addA($something)
    {
        $this->A = $something;
    }
    public function addB($something)
    {
        $this->B = $something;
    }
    public function addC($something)
    {
        $this->C = $something;
    }
}
...
class Builder1 extends Builder
{
    ...
    {
        $this->Product->addA('我创建了A1');
    }

    function createPartB()
    {
        $this->Product->addB('我创建了B1);
    }

    function createPartC()
    {
        $this->Product->addC('我创建了C1');
    }
}
...
class Builder2 extends Builder
{
    ...
    function createPartB()
    {
        $this->Product->addB('我创建了B2');
    }

    function createPartC('我创建了C2’)
    {
        $this->Product->addC();
    }
}
